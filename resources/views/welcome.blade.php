...
<!-- Hero Section -->
<div class="jumbotron text-center" style="background-image: url('images/banner.png'); background-size: cover; background-repeat: no-repeat; position: relative; height: 90vh; display: flex; align-items: center; justify-content: center;">
    <div class="overlay"></div> <!-- Lapisan gelap -->
    <div style="position: relative; z-index: 2; color: white; text-align: center; display: flex; justify-content: space-between; flex-direction: column; align-items: center;">
        <div class="col-md-8">
            ...
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Suscipit illum autem soluta minima totam doloremque ab voluptas sequi consequatur ipsam!</p>
        </div>
            ...
            <div class="col-md-4">
                <div class="card border-0 hover-card">
                    <div class="d-flex justify-content-center align-items-center">
                        <img src="{{ asset('images/img.jpeg') }}" alt="Hero Image" style="height: 50px;width: 50px;" class="img-fluid rounded-circle my-3">
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">SAW</h5>
                        <p class="card-text">Where does it come from?
                            Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden.</p>
                    </div>
                </div>
            </div>
