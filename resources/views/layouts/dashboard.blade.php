        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="dropdown {{ request()->is('books*') || request()->is('categories*') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Kelola Kos</span></a>
              ...
              <li class="dropdown ">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Data spk</span></a>
                <ul class="dropdown-menu">
              ...
              <li>
                <a class="nav-link" href="{{asset('users')}}"><i class="far fa-user"></i> <span>Data User</span></a>
            </li>
            <li>
                <a class="nav-link" href="{{asset('users')}}"><i class="far fa-user"></i> <span>Data Member</span></a>
            </li>
