                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ request()->is('home') ? 'active' : '' }}">
                            <a href="{{ route('home') }}" class="nav-link active"><i class="bi bi-people-fill "></i>
                        ...
                        <li class="{{ request()->is('users') ? 'active' : '' }}">
                            <a href="{{ route('users.index') }}" class="nav-link active"><i
                                    class="far fa-user "></i> <span>Data User</span></a>
                        </li>

                        <li class="{{ request()->is('members') ? 'active' : '' }}">
                            <a href="{{ route('members.index') }}" class="nav-link active"><i
                                    class="bi bi-people-fill "></i> <span>Data Member</span></a>
                        </li>
