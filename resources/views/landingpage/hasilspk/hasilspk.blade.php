...
<div style="height: 100px"></div>
   <div class="container">
    ...
    <div class="row d-flex align-items-center shadow my-5 p-5 rounded-3" >
        ...
        <div class="col-md-5 ">
          <div class="d-flex gap-3 align-items-center mb-4">
            ...
            <h2 class="fs-2 align-items-center fw-semibold"> Hasil : 0980.990798</h2>
          </div>
    ...
    <div class="row d-flex align-items-center shadow my-5 p-5 rounded-3" >
      ...
      <div class="col-md-5 ">
        <div class="d-flex gap-3 align-items-center mb-4">
          <div style="width:50px;height:50px;border-radius:50%;background-color:rgb(26, 26, 27);" class="p-1 text-center text-white ">
            <h2 class="fw-bold my-auto">2</h2>
          </div>
          <h2 class="fs-2 align-items-center fw-semibold"> Hasil : 0889.990798</h2>
        </div>
          <h1  class="fw-semibold mb-3">Kos Alfina</h1>
          <span  class="p-1 px-3" style="border: 1px solid #aeaeae">Putri</span>
          <p class="mt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam ut perferendis aliquid</p>
          <p class="m-0">Lorem ~ ipsum dolor ~ sit amet.</p>
          <p class="my-3"><span class="fw-bold text-danger fs-2 ">RP.20.000.000 </span>/Bulan</p>
          <a href="#" class="btn btn-dark d-block py-3 fw-semibold">Pesan Sekarang</a>
  ...
  <div class="row d-flex align-items-center shadow my-5 p-5 rounded-3" >
    ...
    <div class="col-md-5 ">
      <div class="d-flex gap-3 align-items-center mb-4">
        <div style="width:50px;height:50px;border-radius:50%;background-color:rgb(26, 26, 27);" class="p-1 text-center text-white ">
          <h2 class="fw-bold my-auto">3</h2>
        </div>
        <h2 class="fs-2 align-items-center fw-semibold"> Hasil : 0989.990798</h2>
      </div>
        <h1  class="fw-semibold mb-3">Kos Sakinah</h1>
        <span  class="p-1 px-3" style="border: 1px solid #aeaeae">Putra</span>
        <p class="mt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam ut perferendis aliquid</p>
        <p class="m-0">Lorem ~ ipsum dolor ~ sit amet.</p>
        <p class="my-3"><span class="fw-bold text-danger fs-2 ">RP.20.000.000 </span>/Bulan</p>
...
<div class="row d-flex align-items-center shadow my-5 p-5 rounded-3" >
  ...
  <div class="col-md-5 ">
    <div class="d-flex gap-3 align-items-center mb-4">
      <div style="width:50px;height:50px;border-radius:50%;background-color:rgb(26, 26, 27);" class="p-1 text-center text-white ">
        <h2 class="fw-bold my-auto">4</h2>
      </div>
      <h2 class="fs-2 align-items-center fw-semibold"> Hasil : 0989.990798</h2>
    </div>
      <h1  class="fw-semibold mb-3">Kos mawada</h1>
      <span  class="p-1 px-3" style="border: 1px solid #aeaeae">Putra</span>
      <p class="mt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam ut perferendis aliquid</p>
      <p class="m-0">Lorem ~ ipsum dolor ~ sit amet.</p>
      <p class="my-3"><span class="fw-bold text-danger fs-2 ">RP.20.000.000 </span>/Bulan</p>
...
<div class="row d-flex align-items-center shadow my-5 p-5 rounded-3" >
  ...
  <div class="col-md-5 ">
    <div class="d-flex gap-3 align-items-center mb-4">
      <div style="width:50px;height:50px;border-radius:50%;background-color:rgb(26, 26, 27);" class="p-1 text-center text-white ">
        <h2 class="fw-bold my-auto">5</h2>
      </div>
      <h2 class="fs-2 align-items-center fw-semibold"> Hasil : 0989.990798</h2>
    </div>
      <h1  class="fw-semibold mb-3">Kos Anam</h1>
      <span  class="p-1 px-3" style="border: 1px solid #aeaeae">Putra</span>
      <p class="mt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam ut perferendis aliquid</p>
      <p class="m-0">Lorem ~ ipsum dolor ~ sit amet.</p>
      <p class="my-3"><span class="fw-bold text-danger fs-2 ">RP.20.000.000 </span>/Bulan</p>
